    ...
    def multiply(self, num1: str, num2: str) -> str:
        ...
        def add(num1, num2):
            ...
            for i in range(1, len(num1) + 1):
                ...
                new_sum = add(carry, digit)

                if len(new_sum) == 2:
                    new_carry, new_sum = add(new_carry, new_sum[0]), new_sum[1]
        ...
        print(add("2940", "98"), add("2940", "98") == str((2940 + 98)), 2940 + 98)
...
# while S.multiply(n1, n2) == str(int(n1) * int(n2)):
n1 = "".join([str(randint(1, 9)) for _ in range(N)])
n2 = "".join([str(randint(1, 9)) for _ in range(N)])

# print(
#     S.multiply(n1, n2),
#     str(int(n1) * int(n2)),
#     S.multiply(n1, n2) == str(int(n1) * int(n2)),
# )
